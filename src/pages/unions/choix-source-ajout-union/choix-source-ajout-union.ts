...
export class ChoixSourceAjoutUnionPage {
 ...
 public forms: any;
  ...
  constructor(public translate: TranslateService, public alertCtl: AlertController, public storage: Storage,  public navCtrl: NavController, public navParams: NavParams, private database: PouchdbProvider, public modalCtrl: ModalController) { 
  ...
  ajouter(){
    if(this.confLocaliteEnquete){
      this.navCtrl.push(ChoixSourceAjoutUnionPage, {'confLocaliteEnquete': this.confLocaliteEnquete});
    }else{
